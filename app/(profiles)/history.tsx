...
const HistoryProfile = () => {
  ...
  const handleDelete = useCallback(async() => {
    ...
    try {
      await drizzleDB.delete(profiles).where(eq(profiles.id, parseInt(selectedProfileId, 10))).execute();
      fetchProfiles();
      ...
      >
        <View style={styles.header}>
          ...
          <View>
            ...
            <Text style={styles.headerSubtitle}>Manage your health profiles</Text>
          </View>
          <TouchableOpacity 
            style={styles.addButton}
            onPress={handleAddProfile}
          >
            <MaterialCommunityIcons name="account-plus" size={32} color={theme.text} />
          </TouchableOpacity>
        </View>
          ...
          <View style={styles.content}>
            {profilesData.length === 0 ? (
              <View style={styles.emptyContainer}>
                <Ionicons name="people-circle-outline" size={60} color={theme.text} />
                    ...
                    <View style={styles.profileCard}>
                      <View style={styles.profileHeader}>
                          ...
                          <View style={styles.profileMetaContainer}>
                            <View style={styles.profileMeta}>
                              <FontAwesome5 
                                ...
                                color={theme.text} 
                              />
                              <Text style={styles.profileMetaText}>{profile.gender}</Text>
                            </View>
                        ...
                        <TouchableOpacity 
                          ...
                          onPress={() => handleOpenBottomSheet(profile.id.toString())}
                        >
                      ...
                      {healthData[profile.id] && (
                        <View style={styles.healthIndicators}>
                          <View 
                            style={[
                              styles.indicator, 
                              healthData[profile.id].diabetic === 'Yes' ? styles.indicatorActive : {}
                            ]}
                          >
                            <FontAwesome5 
                              name="syringe" 
                              ...
                              color={theme.text} 
                            />
                            <Text style={styles.indicatorText}>Diabetic</Text>
                          </View>
                          
                          <View 
                            style={[
                              styles.indicator, 
                              healthData[profile.id].hypertensive === 'Yes' ? styles.indicatorActive : {}
                            ]}
                          >
                            <FontAwesome5 
                              name="heartbeat" 
                              ...
                              color={theme.text} 
                            />
                            <Text style={styles.indicatorText}>Hypertensive</Text>
                          </View>
                          
                          <View 
                            style={[
                              styles.indicator, 
                              healthData[profile.id].smoker === 'Yes' ? styles.indicatorActive : {}
                            ]}
                          >
                            <FontAwesome5 
                              name="smoking" 
                              ...
                              color={theme.text} 
                            />
                            <Text style={styles.indicatorText}>Smoker</Text>
                          </View>
                        </View>
                      )}
                      ...
                      <View style={styles.profileFooter}>
                        <View style={styles.lastUpdated}>
                          ...
                          <Text style={styles.lastUpdatedText}>
                            {formatDate(new Date(profile.updated_at).toISOString())}
                          </Text>
                        </View>
